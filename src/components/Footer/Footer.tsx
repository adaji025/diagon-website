...
import { GlobeAltIcon } from "../Svg/Svg";

const navigation = {
  solutions: [
    { name: "Phone Refills", href: "#" },
    { name: "Gift Cards", href: "#" },
  ],
  support: [
    { name: "Help", href: "#" },
    { name: "Contact Us", href: "#" },
    { name: "Product Request", href: "#" },
    { name: "Purchase Limits", href: "#" },
  ],
  company: [
    { name: "Careers", href: "#" },
    { name: "Press", href: "#" },
  ...
  resources: [
    { name: "Integrate POINTS", href: "#" },
    { name: "Refer-for-Reward", href: "#" },
...
export default function Footer() {
  ...
  return (
    <>
      ...
      <footer
        className="bg-black pt-20 text-white"
